...
interface AppLayoutProps {
  ...
  // Set sidebar closed on mobile initially
  React.useEffect(() => {
  ...
  const handleSignOut = async () => {
    ...
    <div className="min-h-screen bg-background">
      {/* Header */}
      <div className="fixed top-0 left-0 right-0 h-16 bg-card/80 backdrop-blur-lg border-b z-50 flex items-center px-4 shadow-sm">
            <Button 
            variant="ghost" 
            size="icon"
      ...
      {/* Sidebar */}
      <aside className={cn(
        "fixed top-16 left-0 h-[calc(100%-4rem)] w-64 bg-sidebar/95 backdrop-blur-xl border-r shadow-xl transition-transform duration-300 ease-in-out z-40 flex flex-col",
